...
export default function MapControls({ onLayerChange, onSearch, onFilterChange }: MapControlsProps) {
  ...
  return (
    <motion.div 
      ...
      animate={{ width: isExpanded ? '300px' : '50px', height: isExpanded ? 'auto' : '50px' }}
        ...
        >
          ...
          <div>
            ...
            <div className="flex flex-col space-y-2">
              {[
                { status: 'Critically Endangered', color: 'bg-red-500', hoverColor: 'hover:bg-red-600', dotColor: 'bg-red-700' },
                { status: 'Endangered', color: 'bg-orange-500', hoverColor: 'hover:bg-orange-600', dotColor: 'bg-orange-700' },
                { status: 'Vulnerable', color: 'bg-yellow-500', hoverColor: 'hover:bg-yellow-600', dotColor: 'bg-yellow-700' },
                ...
                >
                  <div className={`w-4 h-4 rounded-full mr-2 ${dotColor}`}></div>
                  {status}
                </button>
              ))}
            </div>

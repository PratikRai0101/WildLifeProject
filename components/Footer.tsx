    ...
    <footer className="bg-green-800 text-white py-8">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link href="/animals" className="hover:underline">Adopt an Animal</Link></li>
              <li><Link href="/volunteer" className="hover:underline">Virtual Volunteering</Link></li>
            </ul>
          </div>
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link href="/about#team" className="hover:underline">Team</Link></li>
        ...
        <div className="mt-8 border-t border-green-700 pt-8 text-center">
          <p>&copy; 2023 WildLife Connect. All rights reserved.</p>
        </div>
      </div>
    </footer>
  )
